# P2pKit documentation

This directory separates current user and maintainer guidance from historical
remediation records. Start with the repository [README](../README.md).
