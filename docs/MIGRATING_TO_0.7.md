# Migrating from 0.6.x to 0.7.0-rc1

P2pKit 0.7.0-rc1 changes the default runtime security profile. This is a deliberate
new-version migration; do not replace or republish any existing `0.6.x`
artifact with the 0.7 source.

## Compatibility summary

| Concern | 0.6.x default | 0.7.0-rc1 default |
|---|---|---|
...
Update every P2pKit module together to `0.7.0-rc1`. Do not rely on a global
