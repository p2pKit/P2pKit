...
1. Obtain a supported ordinary-user Mac with functioning multicast and applicable simulator
   ...
   runner census returned zero; the owner access question remains unanswered, not authorized.
...
immutable RC3 and 0.8.0+ behavior restrictions. No issue closure, merge, tag or publication authority.
...
Earlier hypotheses/narratives below remain dated and do not reinstate completed repairs.
<!-- audit-current:end -->
...
#378 is the now-confirmed read-only Windows cleanup cause; #379 is the separate peers subscription-hook defect, not #173 fusion. Keep #274/#284 owner decisions and #287 refuted-contract row in the denominator without inventing repairs. Do not refile known causes; older suspicions below keep their original evidentiary limits.
...
General shell-checkout CRLF and generated-batch CRCRLF remain UNCONFIRMED. #372/#373 are now actually
filed distinct causes, not untracked suspicions; only373 is repaired/approved. Do not invent Android17
execution, native device numbers, unavailable JSONL/patch contents or inherited approval of another cause.

## Preserved bafe905 hypotheses and disposition notes
