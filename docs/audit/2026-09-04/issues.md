...
| --- | --- |
| [#410](https://github.com/p2pKit/P2pKit/issues/410) | Sole active WIP; Linux R2 aggregate FAILED; source corrections NOT_RUN, full locks/Mac qualification/final approval pending. |
...
| [#417](https://github.com/p2pKit/P2pKit/issues/417) | Queued, source-confirmed/runtime NOT_RUN: overflow response continuations lose requester destination/transaction ID; no demonstrated default discovery outage. |
| [#413](https://github.com/p2pKit/P2pKit/issues/413) | Approved option-B plan only, implementation NOT_STARTED; own Kotlin collection disposal while preserving #383 fences and bounded raw-export failure. |
| [#409](https://github.com/p2pKit/P2pKit/issues/409) | Queued, NOT_STARTED: source/session-bound pre-dial readiness and first-offer clock. |
| [#411](https://github.com/p2pKit/P2pKit/issues/411) | Queued, NOT_STARTED: safe host-passphrase instructions without credential exposure or weakening #324. |
| [#412](https://github.com/p2pKit/P2pKit/issues/412) | Queued, NOT_STARTED: same-process contention with A already joined; absent #157 harness remains a prerequisite. |
