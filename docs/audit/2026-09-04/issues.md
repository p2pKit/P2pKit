...
| --- | --- |
| [#415](https://github.com/p2pKit/P2pKit/issues/415) | Sole active/preparing; source-confirmed extended-RCODE warning value only, not packet acceptance. Runtime/repair NOT_RUN. |
| [#416](https://github.com/p2pKit/P2pKit/issues/416) | Next; source-confirmed reverse-domain substring parsing in accepted explicit-legacy names. Runtime/repair NOT_RUN. |
| [#413](https://github.com/p2pKit/P2pKit/issues/413) | Approved option-B plan only, implementation NOT_STARTED; native admission unknown; preserve #383 fences. |
...
## Latest source-only approvals (3)
...
The PENDING_REMEDIATION bucket has **11 rows (10 Low + 1 Medium)**: nine repairs
(8 Low + 1 Medium) plus owner #274/#284; #120 is separate. #207 retains one scoped repair
