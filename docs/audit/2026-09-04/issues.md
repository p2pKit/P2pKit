...
| --- | --- |
| [#408](https://github.com/p2pKit/P2pKit/issues/408) | Exact R2 source committed; source/local execution and commit binding approved, native reuse/probe and final approval pending. |
| [#207](https://github.com/p2pKit/P2pKit/issues/207) | Reopened same-cause Windows core fixture/adopter follow-through; keep historical R15 approval and strict diagnostics. |
| [#410](https://github.com/p2pKit/P2pKit/issues/410) | Confirmed real-dependency failed-recovery timer retention after ordinary close; no repair yet or R16/Android runtime attribution. |
| [#409](https://github.com/p2pKit/P2pKit/issues/409) | Pre-dial UI readiness/first-offer clock repair queued after410; no implementation or approval yet. |
...
The PENDING_REMEDIATION bucket has6 rows: current repairs plus owner274/284;120is separate. 207current reopening does not erase dated R15 approval;408local/R18readiness is not native or finalrepair approval. Successful Windows components do not convert its failed host intoPASS.
<!-- audit-current:end -->
