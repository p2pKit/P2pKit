...
| --- | --- |
| [#410](https://github.com/p2pKit/P2pKit/issues/410) | Sole active repair, implementation STARTING/validation NOT_RUN; failed-recovery timer disposal, no repair approval or R16/Android cause attribution. |
| [#413](https://github.com/p2pKit/P2pKit/issues/413) | Approved plan only, implementation NOT_STARTED; owned Kotlin collection disposal must retain #383 fences and the bounded raw-export failure. |
...
| [#411](https://github.com/p2pKit/P2pKit/issues/411) | Queued, NOT_STARTED: correct host-passphrase instruction without credential exposure or weakening #324. |
...
The PENDING_REMEDIATION bucket has7 rows: five repairs plus owner274/284;120 is separate.207 Windows19 approval restores one repair credit; prior R15 approval and Windows17 failures remain historical. Focused Windows19 PASS is not whole-host or audit acceptance.
<!-- audit-current:end -->
