...
| --- | --- |
| [#207](https://github.com/p2pKit/P2pKit/issues/207) | Sole active repair; source ready, focused checks/Windows78 pending, NOT_NATIVE_RUN / not final-approved. Historical R15 approval and strict diagnostics retained. |
| [#410](https://github.com/p2pKit/P2pKit/issues/410) | Queued, NOT_STARTED: failed-recovery timer disposal after ordinary close; no R16/Android runtime attribution. |
| [#413](https://github.com/p2pKit/P2pKit/issues/413) | Queued, NOT_STARTED: owned Kotlin collection cancellation/disposal; genuine bounded native failure, not indefinite/all-collector proof. |
...
| [#411](https://github.com/p2pKit/P2pKit/issues/411) | Queued, NOT_STARTED: correct host-passphrase instruction without exposing credentials or weakening #324. |
| [#412](https://github.com/p2pKit/P2pKit/issues/412) | Queued, NOT_STARTED: same-process shared-arbiter contention with A already joined; absent #157 harness remains a prerequisite. |
...
The PENDING_REMEDIATION bucket has8 rows: six repairs plus owner274/284;120 is separate. Current207 reopening preserves dated R15 approval.408 gains one native-proven repair approval; R18 cancellation failure remains413 and does not become PASS through successful retirement.
<!-- audit-current:end -->
