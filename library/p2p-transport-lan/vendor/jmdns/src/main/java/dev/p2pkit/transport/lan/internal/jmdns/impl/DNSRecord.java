...
import dev.p2pkit.transport.lan.internal.jmdns.impl.DNSOutgoing.MessageOutputStream;
...
public abstract class DNSRecord extends DNSEntry {
    ...
    /*
     * (non-Javadoc)
     * @see dev.p2pkit.transport.lan.internal.jmdns.impl.DNSEntry#equals(java.lang.Object)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see dev.p2pkit.transport.lan.internal.jmdns.impl.DNSEntry#isExpired(long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see dev.p2pkit.transport.lan.internal.jmdns.impl.DNSEntry#isStale(long)
     */
    @Override
    ...
    * Increment the percentage that determines whether a record needs to be refreshed.
    ...
    public static class IPv4Address extends Address {
        ...
        /*
         * (non-Javadoc)
         * @see dev.p2pkit.transport.lan.internal.jmdns.impl.DNSRecord#getServiceInfo(boolean)
         */
        @Override
    ...
    public static abstract class Address extends DNSRecord {
            ...
            if (dns.getLocalHost().conflictWithRecord(this)) {
                ...
                if (localAddress != null) {
                    ...
                    if (dns.isProbing() && comparison > 0) {
                        ...
                        if (!dns.renameHostAfterConflict()) {
                            return false;
                        }
                    }
                    dns.revertState();
        ...
        /*
         * (non-Javadoc)
         * @see dev.p2pkit.transport.lan.internal.jmdns.impl.DNSRecord#getServiceEvent(dev.p2pkit.transport.lan.internal.jmdns.impl.JmDNSImpl)
         */
        @Override
    ...
    public static class Pointer extends DNSRecord {
        ...
        /*
         * (non-Javadoc)
         * @see dev.p2pkit.transport.lan.internal.jmdns.impl.DNSEntry#isSameEntry(dev.p2pkit.transport.lan.internal.jmdns.impl.DNSEntry)
         */
        @Override
            ...
            if (info != null && (info.isAnnouncing() || info.isAnnounced()) && (_port != info.getPort() || !_server.equalsIgnoreCase(dns.getLocalHost().getName()))) {
                ...
                if (info.isProbing() && comparison > 0) {
                    ...
                    String replacement = NameRegister.Factory.getRegistry().incrementName(
                            dns.getLocalHost().getInetAddress(), info.getName(), NameRegister.NameType.SERVICE);
                    String instance = replacement == null ? "" : replacement;
                    String newKey = (instance.isEmpty() ? info.getType() : instance + "." + info.getType()).toLowerCase();
                    if (!dns.publishServiceRename(info, oldName, replacement, newKey)) {
                        return false;
                    }
                    ...
                    dns.revertServiceAfterConflict(info);
                } else {
    ...
    public static class HostInformation extends DNSRecord {
        ...
        /*
         * (non-Javadoc)
         * @see dev.p2pkit.transport.lan.internal.jmdns.impl.DNSRecord#addAnswer(dev.p2pkit.transport.lan.internal.jmdns.impl.JmDNSImpl, dev.p2pkit.transport.lan.internal.jmdns.impl.DNSIncoming, java.net.InetAddress, int, dev.p2pkit.transport.lan.internal.jmdns.impl.DNSOutgoing)
         */
        @Override
        DNSOutgoing addAnswer(JmDNSImpl dns, DNSIncoming in, InetAddress addr, int port, DNSOutgoing out) {
            return out;
        ...
        /*
         * (non-Javadoc)
         * @see dev.p2pkit.transport.lan.internal.jmdns.impl.DNSRecord#handleQuery(dev.p2pkit.transport.lan.internal.jmdns.impl.JmDNSImpl, long)
         */
        @Override
        boolean handleQuery(JmDNSImpl dns, long expirationTime) {
            return false;
        ...
        /*
         * (non-Javadoc)
         * @see dev.p2pkit.transport.lan.internal.jmdns.impl.DNSRecord#handleResponse(dev.p2pkit.transport.lan.internal.jmdns.impl.JmDNSImpl)
         */
        @Override
        boolean handleResponse(JmDNSImpl dns) {
            return false;
        ...
        /*
         * (non-Javadoc)
         * @see dev.p2pkit.transport.lan.internal.jmdns.impl.DNSRecord#sameValue(dev.p2pkit.transport.lan.internal.jmdns.impl.DNSRecord)
         */
        @Override
        boolean sameValue(DNSRecord other) {
        ...
        /*
         * (non-Javadoc)
         * @see dev.p2pkit.transport.lan.internal.jmdns.impl.DNSRecord#isSingleValued()
         */
        @Override
        public boolean isSingleValued() {
            return true;
        ...
        /*
         * (non-Javadoc)
         * @see dev.p2pkit.transport.lan.internal.jmdns.impl.DNSRecord#write(dev.p2pkit.transport.lan.internal.jmdns.impl.DNSOutgoing)
         */
        @Override
        void write(MessageOutputStream out) {
