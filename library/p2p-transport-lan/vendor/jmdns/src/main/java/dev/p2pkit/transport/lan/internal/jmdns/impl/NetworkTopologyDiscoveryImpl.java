...
public class NetworkTopologyDiscoveryImpl implements NetworkTopologyDiscovery {
    ...
    /*
     * (non-Javadoc)
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmmDNS.NetworkTopologyDiscovery#getInetAddresses()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see dev.p2pkit.transport.lan.internal.jmdns.NetworkTopologyDiscovery#lockInetAddress(java.net.InetAddress)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see dev.p2pkit.transport.lan.internal.jmdns.NetworkTopologyDiscovery#unlockInetAddress(java.net.InetAddress)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmmDNS.NetworkTopologyDiscovery#useInetAddress(java.net.NetworkInterface, java.net.InetAddress)
     */
    @Override
