...
public interface NameRegister {
    ...
    class UniqueNamePerInterface extends BaseRegister {
        ...
        /*
         * (non-Javadoc)
         * @see dev.p2pkit.transport.lan.internal.jmdns.impl.NameRegister#register(java.net.InetAddress, java.lang.String, dev.p2pkit.transport.lan.internal.jmdns.impl.NameRegister.NameType)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see dev.p2pkit.transport.lan.internal.jmdns.impl.NameRegister#checkName(java.net.InetAddress, java.lang.String, dev.p2pkit.transport.lan.internal.jmdns.impl.NameRegister.NameType)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see dev.p2pkit.transport.lan.internal.jmdns.impl.NameRegister#incrementHostName(java.net.InetAddress, java.lang.String, dev.p2pkit.transport.lan.internal.jmdns.impl.NameRegister.NameType)
         */
        @Override
