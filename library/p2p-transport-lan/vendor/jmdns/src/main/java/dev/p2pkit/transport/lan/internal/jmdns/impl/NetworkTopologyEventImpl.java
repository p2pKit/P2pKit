...
public class NetworkTopologyEventImpl extends NetworkTopologyEvent implements Cloneable {
    ...
    /*
     * (non-Javadoc)
     * @see dev.p2pkit.transport.lan.internal.jmdns.NetworkTopologyEvent#getDNS()
     */
    @Override
    public JmDNS getDNS() {
    ...
    /*
     * (non-Javadoc)
     * @see dev.p2pkit.transport.lan.internal.jmdns.NetworkTopologyEvent#getInetAddress()
     */
    @Override
