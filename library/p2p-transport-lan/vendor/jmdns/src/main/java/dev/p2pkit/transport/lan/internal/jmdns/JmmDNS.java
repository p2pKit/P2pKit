 ...
 */
package dev.p2pkit.transport.lan.internal.jmdns;
...
import dev.p2pkit.transport.lan.internal.jmdns.impl.JmmDNSImpl;
...
public interface JmmDNS extends Closeable {
     ...
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#getName()
     */
    String[] getNames();
     ...
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#getHostName()
     */
    String[] getHostNames();
     ...
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#getInetAddress()
     */
     ...
     * @return InetAddress[] of Internet Address
     * @exception IOException if any IO error occurs
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#getInterface()
     ...
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String)
     */
     ...
     * @return ServiceInfo[] list of service info. If no service info is found the list is empty.
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, long)
     */
     ...
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, boolean)
     */
     ...
     *            if <code>true</code> ServiceListener.resolveService will be called whenever new information is received.
     * @return ServiceInfo[] list of service info. If no service info is found the list is empty.
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, boolean, long)
     */
     ...
     * @param name
     *            unqualified service name, such as <code>foobar</code> .
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String)
     */
     ...
     * @param persistent
     *            if <code>true</code> ServiceListener.resolveService will be called whenever new information is received.
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, boolean)
     */
     ...
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, long)
     */
     ...
     * @param timeout
     *            timeout in milliseconds
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, boolean, long)
     */
     ...
     * @exception IOException if any IO error occurs
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#addServiceTypeListener(dev.p2pkit.transport.lan.internal.jmdns.ServiceTypeListener)
     */
     ...
     * @param listener
     *            listener for service types
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#removeServiceTypeListener(dev.p2pkit.transport.lan.internal.jmdns.ServiceTypeListener)
     */
     ...
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#addServiceListener(java.lang.String, dev.p2pkit.transport.lan.internal.jmdns.ServiceListener)
     */
     ...
     * @param listener
     *            listener for service updates
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#removeServiceListener(java.lang.String, dev.p2pkit.transport.lan.internal.jmdns.ServiceListener)
     */
     ...
     * @exception IOException if any IO error occurs
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#registerService(dev.p2pkit.transport.lan.internal.jmdns.ServiceInfo)
     */
     ...
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#unregisterService(dev.p2pkit.transport.lan.internal.jmdns.ServiceInfo)
     */
     ...
     *
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#unregisterAllServices()
     */
     ...
     * @param type
     *            full qualified service type, such as <code>_http._tcp.local.</code>.
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#registerServiceType(java.lang.String)
     */
     ...
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#list(java.lang.String)
     */
     ...
     * @return An array of service instance.
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#list(java.lang.String, long)
     */
     ...
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#listBySubtype(java.lang.String)
     */
     ...
     *            timeout in milliseconds. Typical timeout should be 6s.
     * @return A dictionary of service info by subtypes.
     * @see dev.p2pkit.transport.lan.internal.jmdns.JmDNS#listBySubtype(java.lang.String, long)
     */
