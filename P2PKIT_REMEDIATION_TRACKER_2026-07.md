...
| LAN-T08 | Oversized TXT, unsupported pv, control characters, duplicate-PID spoof, off-subnet hosts, alternate address candidates, and connection flood | LAN-04, LAN-15, LAN-16, LAN-18, LAN-22 | Planned | Connection-admission flood conjunct implemented in `b21ed84`; hostile record/address conjuncts remain open | `b21ed84` partial; push blocked | Hostile-network/device evidence partly required |
