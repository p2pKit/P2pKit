...
| LAN-T07 | Apple browser/listener recovery, start-close race, parent cancellation, inbound flood/drain, cache-prune race, same-type path rotation, and AWDL | LAN-03, LAN-04, LAN-11, LAN-12, LAN-13, LAN-17 | Planned | Parent-connect cancellation and bounded inbound flood/drain conjuncts implemented in `b21ed84`; remaining browser/cache/rotation/AWDL work is open | `b21ed84` partial; push blocked | Simulator plus physical Apple evidence required where applicable |
...
| LAN-T10 | Prove old Apple listener descriptors released, not merely new port differs | LAN-11, LAN-23 | Planned | Terminal references/ports clear in `b21ed84`; native descriptor-release proof remains open | `b21ed84` partial; push blocked | Apple platform evidence required |
