...
| Source control/post-commit | Pending focused commit at this record update; committed-state hash and rerun will be recorded after the desktop code commit, followed by a tracker-only evidence commit. |
