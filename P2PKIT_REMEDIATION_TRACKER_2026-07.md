...
| LAN-14 | Medium | Synthetic cache heartbeat treats presence as liveness | LAN-NET-01 | Implemented | Remove synthetic JVM/Android/Apple cache heartbeats; native DNS-SD/browser removal or TTL owns liveness and exact `Lost` | TTL/liveness tests | `21bc2fc`; local, push blocked | Local lifetime contract and JVM/Apple goodbye tests pass; abrupt native-departure evidence remains |
