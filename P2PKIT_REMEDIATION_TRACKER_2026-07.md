...
| LAN-16 | Medium security | Discovery records trusted too broadly | SEC-01 dependency; LAN-NET-01 | Planned | Partial: authenticated handshake already verified; full bounded schema, exact service/TXT identity, and validated TXT-less removal ownership implemented; subnet affinity and candidate retry remain | LAN-T08 | `2895ff1` partial; push blocked | Crafted JmDNS blank/other-app/duplicate-identity records are rejected and admitted goodbye emits exact Lost; address conjuncts remain open |
...
| LAN-T07 | Apple browser/listener recovery, start-close race, parent cancellation, inbound flood/drain, cache-prune race, same-type path rotation, and AWDL | LAN-03, LAN-04, LAN-11, LAN-12, LAN-13, LAN-17 | In Progress | Browser/listener recovery, start cancellation, cancelled close, bounded inbound drain, outbound cancellation, and cache-prune race implemented; same-type path rotation/AWDL remain in LAN-NET-01 | `b21ed84`, `703182a`; push blocked | 6 recovery tests; Apple suite 50 registered/49 executed/0 failed/1 manual ignored; physical path/AWDL evidence remains |
| LAN-T08 | Oversized TXT, unsupported pv, control characters, duplicate-PID spoof, off-subnet hosts, alternate address candidates, and connection flood | LAN-04, LAN-15, LAN-16, LAN-18, LAN-22 | Planned | Connection flood implemented in `b21ed84`; TXT size/version/control/service-identity and diagnostic conjuncts implemented in `2895ff1`/`09af6b5`; off-subnet and alternate-address conjuncts remain | Three commits partial; push blocked | Hostile-network/device evidence and address-selection tests remain required |
