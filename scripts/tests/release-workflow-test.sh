...
ruby "$ROOT/scripts/tests/check-windows-directory-control-policy-test.rb"
...
python3 -I -B -S "$ROOT/scripts/tests/hosted-lock-resources-test.py"
python3 -I -B -S "$ROOT/scripts/tests/hosted-apple-link-test.py"
python3 -I -B -S "$ROOT/scripts/tests/encrypt-hosted-evidence-test.py"
ruby "$ROOT/scripts/tests/sample-release-workflow-test.rb"
python3 -I -B -S "$ROOT/scripts/tests/publish-sample-release-test.py"
ruby "$ROOT/scripts/tests/check-consumer-gradle-policy-test.rb"
ruby "$ROOT/scripts/tests/check-mac-host-admission-policy-test.rb"
python3 -I -B -S "$ROOT/scripts/tests/run-mac-host-admission-test.py"
ruby "$ROOT/scripts/tests/check-hosted-iphoneos-product-policy-test.rb"
python3 -I -B -S "$ROOT/scripts/tests/run-hosted-iphoneos-product-test.py"
