...
EMBEDDED_IDENTITY = {
    "group": "dev.p2pkit.internal", "name": "jmdns", "version": "3.6.3-p2pkit.410.4",
    "bomRef": "urn:p2pkit:embedded:jmdns:3.6.3-p2pkit.410.4",
    "purl": "pkg:generic/p2pkit/jmdns@3.6.3-p2pkit.410.4",
}
UPSTREAM = {
